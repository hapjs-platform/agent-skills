...
将源文件移动到指定位置，接口中使用的 URI 描述请参考[文件组织](../../framework/file-organization.md)
...
将源文件复制一份并存储到指定位置，接口中使用的 URI 描述请参考[文件组织](../../framework/file-organization.md)
...
获取指定目录下的文件列表，接口中使用的 URI 描述请参考[文件组织](../../framework/file-organization.md)
...
获取本地文件的文件信息，接口中使用的 URI 描述请参考[文件组织](../../framework/file-organization.md)

#### 参数：

| 参数名            | 类型     | 必填 | 说明                                                                 |
| ----------------- | -------- | ---- | -------------------------------------------------------------------- |
| uri               | String   | 是   | 文件的 uri，不能是应用资源路径。`1080+`支持应用资源路径              |
...
| subFiles `1060+` | Array  | 文件列表，recursive 为 true 且 type 为 dir 时递归返回子目录文件细信息，否则不返回 |
...
删除本地存储的文件，接口中使用的 URI 描述请参考[文件组织](../../framework/file-organization.md)
