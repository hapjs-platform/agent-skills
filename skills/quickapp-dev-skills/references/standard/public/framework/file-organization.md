...
一个应用包含：描述项目配置信息的[manifest 文件](manifest.md)，放置项目公共资源脚本的[app.ux 文件](source-file.md)，多个描述页面/自定义组件的[ux 文件](source-file.md)，典型示例如下：
...
URI 用于标识应用资源和文件，[组件](../widgets/common-events.md)和[接口](../features/index.md)通过 URI 来访问应用资源和文件。
